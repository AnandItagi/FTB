...
import { ScrollView, Text, ListView, Image, View, TouchableOpacity, Linking } from 'react-native'
      ...
      <View style={styles.container}>
        ...
        <ShareSheet visible={this.state.visible} onCancel={this.onCancel.bind(this)}>
          ...
          <Button iconSrc={{ uri: GOOGLE_PLUS_ICON }}
            onPress={() => {
              const url = 'whatsapp://send?text=hello&phone=9844050512';
              ...
              //Linking.openURL('whatsapp://send?text=hello&phone=9844050512')
              this.onCancel();
              {/*setTimeout(() => {
                Share.shareSingle(Object.assign(shareOptions, {
                  "social": "googleplus"
